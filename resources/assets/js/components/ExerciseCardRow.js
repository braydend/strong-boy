	...
	render() {
		return (
			<tr>
				...
				<td>{!this.state.edit ? (this.state.weight === 0 ? "Bodyweight" : (this.state.weight < 0 ? `Bodyweight - ${this.state.weight * -1}` : this.state.weight)) : <InputGroup><FormControl name="weight" defaultValue={this.state.weight} onChange={this.handleChange} /></InputGroup>}</td>
